...
$commandesProduits = $commandeProduit->obtenirProduits();
...
<div class="container mt-4">
    <h1 class="text-center text-primary bold">NOS PRODUITS DISPINIBLES</h1>
        ...
        <tbody>
            <?php foreach ($commandesProduits as $cp): ?>
                <tr>
                    ...
                    <td><?= htmlspecialchars($cp['prix']) ?></td>
                    <td><?= htmlspecialchars($cp['description']) ?></td>
